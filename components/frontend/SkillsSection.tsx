...
export default function SkillsSection({ data }: { data: any[] }) {
  ...
  return (
    // STANDARDIZED WRAPPER: Matches About, Experience, and Education exactly
    <section
      id="skills"
      className="w-[calc(100%-2rem)] md:w-[calc(100%-4rem)] xl:w-full max-w-[1400px] mx-auto bg-card/20 border border-border/40 py-12 md:py-16 my-8 relative overflow-hidden rounded-[2.5rem] md:rounded-[4rem]"
    >
